...
ActiveRecord::Schema.define(:version => 20130114121260) do
  ...
  add_index "spree_tax_rate_translations", ["spree_tax_rate_id"], :name => "index_31892373772ae64b7b20882303f0fdf4825cd71e"
